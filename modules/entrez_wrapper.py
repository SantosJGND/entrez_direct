...
class EntrezQuery(ABC):
    ...
    @abstractmethod
    def read_output(self, outptuf_path: str) -> pd.DataFrame:
        pass
...
class EntrezWrapper:
    ...
    def __init__(self, bindir: str, outdir: str, outfile: str, query_type: str= "fetch_taxid_description",chunksize: int = 1000):
    ...
    def cmd_chunks(self, query: List[str]) -> List[str]:
        ...
        chunks = [query[i:i + self.chunksize] for i in range(0, len(query), self.chunksize)]
